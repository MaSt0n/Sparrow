...
const shape = (type, context, attributes) => {
...
const line = (context, attributes) => shape('line', context, attributes);
...
const circle = (context, attributes) => shape('circle', context, attributes);

const text = (context, attributes) => {
...
const path = (context, attributes) => {
  const { d } = attributes;
  return shape('path', context, { ...attributes, d: d.flat().join(' ') });
};

const ring = (context, attributes) => {
